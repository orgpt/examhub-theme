...
function examhub_register_options_fields() {
    ...
    acf_add_local_field_group( [
        ...
        'fields' => [
            ...
            [ 'key' => 'field_ai_ocr_endpoint',  'label' => 'OCR API Endpoint',          'name' => 'ai_ocr_endpoint',     'type' => 'text', 'default_value' => '', 'instructions' => 'ضع مسار OCR (مثل /v1/ocr) أو رابط كامل https://... إذا كان لديك OCR Gateway خاص. ملاحظة: واجهة DeepSeek الرسمية لا توفر endpoint OCR مباشر لرفع PDF.' ],
