...
function examhub_register_options_fields() {
    ...
    acf_add_local_field_group( [
        ...
        'fields' => [
            ...
            [ 'key' => 'field_opt_free_limit',   'label' => 'الأسئلة المجانية/يوم', 'name' => 'free_questions_per_day', 'type' => 'number', 'default_value' => 10, 'min' => 1 ],
        ...
        'fields' => [
            [
                ...
                'sub_fields'   => [
                    ...
                    [ 'key' => 'field_plan_q_limit',       'label' => 'حد الأسئلة/يوم',       'name' => 'plan_questions_limit', 'type' => 'number', 'default_value' => 0 ],
